...
export default {
    async fetch(request, env, ctx) {
        ...
        /*
         * Call the user-defined WASM fetch handler.
         * The C-side worker_fetch() function creates a worker_request_t,
         * calls worker_handle_fetch(req, env), and returns the response
         * pointer.  The env/ctx are managed on the C side (set up during
         * worker_init or via worker_set_router).
         */
